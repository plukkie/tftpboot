...
POSTSCRIPT_FILE=postscript_gns3_dev_fabric.sh
CLI_CONF_FILE=ztd_gns3_dev_fabric.conf
...
CLI_CONFIG_FILE="$APP$ZTD_SERVER_IP$ZTD_PATH$OS_PATH$CLI_CONF_PATH/$CLI_CONF_FILE"
POST_SCRIPT_FILE="$APP$ZTD_SERVER_IP$ZTD_PATH$OS_PATH$POSTSCRIPT_PATH/$POSTSCRIPT_FILE"
